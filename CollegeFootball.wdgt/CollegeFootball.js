...
function get_logo()
{
    ...
    if(teamID == 344)
    {
        logo = '<img src="http://www.nlsmith.com/collegefootball/logos/mississippi_state.png" />';
    }
    else if(teamID == 256)
    {
        logo = '<img src="http://www.nlsmith.com/collegefootball/logos/james-madison.png" />';
    }
    else if(teamID == 113)
    {
        logo = '<img src="http://www.nlsmith.com/collegefootball/logos/massachusetts.png" />';
    }
    else if(teamID == 227)
    {
        logo = '<img src="http://www.nlsmith.com/collegefootball/logos/rhode-island.png" />';
    }
    else if(teamID == 2729)
    {
        logo = '<img src="http://www.nlsmith.com/collegefootball/logos/william-mary.png" />';
    }
    else
    {
        var SOB = new flashObj();
        SOB.flashFile = "http://espn-ak.starwave.com/swf/clubhouse/ncaa/" + teamID + ".swf";
        SOB.width = "70";
        SOB.height = "70";
        SOB.scale = "noScale";
        SOB.salign="lt";
        SOB.wmode = "transparent";  // Window Mode
        SOB.DenyIEdl = "TRUE";
        SOB.FlashVer = 6;
        SOB.cabVersion = "6,0,48,0";
        SOB.altTxt = "";
        SOB.ID = "headerswf";
        logo = SOB.render();
    }
